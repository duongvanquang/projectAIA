...
class SeriesTabbarSearch extends StatefulWidget {
  const SeriesTabbarSearch({Key? key}) : super(key: key);

  @override
  State<SeriesTabbarSearch> createState() => _SeriesTabbarSearchState();
}

class _SeriesTabbarSearchState extends State<SeriesTabbarSearch> {
  @override
        ...
        builder: (context, state) {
          if (state is SearchLoadInProgress) {
            ...
            final items = state.searchData
                .where((element) => element.mediaType == 'tv')
                .toList();
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: 170,
                                    child: Text(itemdataSearch.originalName!,
                                        style: Theme.of(context)
                                            .textTheme
                                            .headline4!
                                            .copyWith(
