...
class GenresTabbarSearch extends StatefulWidget {
  const GenresTabbarSearch({Key? key}) : super(key: key);

  @override
  State<GenresTabbarSearch> createState() => _GenresTabbarSearchState();
}
        ...
        builder: (context, state) {
          if (state is SearchLoadInProgress) {
            ...
            final items = state.searchData
                .where((element) => element.mediaType == 'genres')
                .toList();
